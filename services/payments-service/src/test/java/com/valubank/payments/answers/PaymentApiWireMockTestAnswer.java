...
class PaymentApiWireMockTestAnswer {
    ...
    void paymentThatExceedsSourceAccountBalanceIsRejectedForInsufficientFunds() {
        ...
        ACCOUNTS_SERVICE.stubFor(post(urlEqualTo("/api/accounts/3/balance-mutations"))
                .willReturn(aResponse()
                        .withStatus(422)
                        .withHeader("Content-Type", "application/json")
        ...
        FRAUD_SERVICE.stubFor(post(urlEqualTo("/api/fraud-checks"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
                        .withBody(Json.write(fraudCheckResponse))));
